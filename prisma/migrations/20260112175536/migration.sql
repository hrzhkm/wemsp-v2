/*
  ...
  - The values [BROTHER,SISTER] on the enum `FamilyRelation` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "FamilyRelation_new" AS ENUM ('FATHER', 'MOTHER', 'SON', 'DAUGHTER', 'SIBLING', 'SPOUSE', 'GRANDFATHER', 'GRANDMOTHER', 'GRANDSON', 'GRANDDAUGHTER', 'UNCLE', 'AUNT', 'NEPHEW', 'NIECE', 'COUSIN', 'OTHER');
